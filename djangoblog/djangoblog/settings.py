...
# 设置参数，在部署的时候修改成部署数据
# 数据库名称
DJANGO_MYSQL_DATABASE = 'blogtestdb'
# 数据库用户名
...
if __name__ == '__main__':
    for app in INSTALLED_BLOG_APPS:
        os.system('python3 {0}/manage.py makemigrations {1}'.format(BASE_DIR,app))
    os.system('python3 {0}/manage.py migrate'.format(BASE_DIR))